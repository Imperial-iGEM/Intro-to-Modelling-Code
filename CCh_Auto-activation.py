...
n=2
#Translation:
ktl = 5e-3              #/s translation constant
...
def ODEs(variables , t):
    ...
    dmRNA_dt = ktx*(Protein**n / (kd + Protein**n)) - delta_mRNA*mRNA #mRNA conc. ODE
...
initial_conditions = [0.0 , 1e-7]        #set the initial values for [mRNA] and [Protein]
